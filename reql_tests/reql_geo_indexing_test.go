...
func (suite *GeoIndexingSuite) TestCases() {
...

	{
		...
		suite.T().Log("About to run line #12: tbl.IndexCreate('g', r.IndexCreateOpts{Geo: true, })")

		runAndAssert(suite.Suite, expected_, tbl.IndexCreate("g", r.IndexCreateOpts{Geo: true, }), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
...

	{
		...
		suite.T().Log("About to run line #16: tbl.IndexCreate('m', r.IndexCreateOpts{Geo: true, Multi: true, })")

		runAndAssert(suite.Suite, expected_, tbl.IndexCreate("m", r.IndexCreateOpts{Geo: true, Multi: true, }), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
...

	{
		...
		suite.T().Log("About to run line #37: tbl.GetIntersecting(r.Point(0, 0), r.GetIntersectingOpts{Index: 'other', }).Count()")

		runAndAssert(suite.Suite, expected_, tbl.GetIntersecting(r.Point(0, 0), r.GetIntersectingOpts{Index: "other", }).Count(), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
...

	{
		...
		suite.T().Log("About to run line #41: tbl.GetIntersecting(r.Point(0, 0), r.GetIntersectingOpts{Index: 'missing', }).Count()")

		runAndAssert(suite.Suite, expected_, tbl.GetIntersecting(r.Point(0, 0), r.GetIntersectingOpts{Index: "missing", }).Count(), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
...

	{
		...
		suite.T().Log("About to run line #47: tbl.GetAllByIndex('g', 0).Count()")

		runAndAssert(suite.Suite, expected_, tbl.GetAllByIndex("g", 0).Count(), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
...

	{
		...
		suite.T().Log("About to run line #51: tbl.Between(0, 1, r.BetweenOpts{Index: 'g', }).Count()")

		runAndAssert(suite.Suite, expected_, tbl.Between(0, 1, r.BetweenOpts{Index: "g", }).Count(), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
...

	{
		...
		suite.T().Log("About to run line #55: tbl.OrderBy(r.OrderByOpts{Index: 'g', }).Count()")

		runAndAssert(suite.Suite, expected_, tbl.OrderBy(r.OrderByOpts{Index: "g", }).Count(), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
...

	{
		...
		suite.T().Log("About to run line #77: tbl.GetIntersecting(r.Point(0, 0), r.GetIntersectingOpts{Index: 'id', }).Count()")

		runAndAssert(suite.Suite, expected_, tbl.GetIntersecting(r.Point(0, 0), r.GetIntersectingOpts{Index: "id", }).Count(), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
...

	{
		...
		suite.T().Log("About to run line #82: tbl.GetIntersecting(r.Point(0, 0), r.GetIntersectingOpts{Index: 'g', }).Count()")

		runAndAssert(suite.Suite, expected_, tbl.GetIntersecting(r.Point(0, 0), r.GetIntersectingOpts{Index: "g", }).Count(), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
...

	{
		...
		suite.T().Log("About to run line #86: tbl.GetIntersecting(r.Point(10, 10), r.GetIntersectingOpts{Index: 'g', }).Count()")

		runAndAssert(suite.Suite, expected_, tbl.GetIntersecting(r.Point(10, 10), r.GetIntersectingOpts{Index: "g", }).Count(), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
...

	{
		...
		suite.T().Log("About to run line #90: tbl.GetIntersecting(r.Point(0.5, 0.5), r.GetIntersectingOpts{Index: 'g', }).Count()")

		runAndAssert(suite.Suite, expected_, tbl.GetIntersecting(r.Point(0.5, 0.5), r.GetIntersectingOpts{Index: "g", }).Count(), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
...

	{
		...
		suite.T().Log("About to run line #94: tbl.GetIntersecting(r.Point(20, 20), r.GetIntersectingOpts{Index: 'g', }).Count()")

		runAndAssert(suite.Suite, expected_, tbl.GetIntersecting(r.Point(20, 20), r.GetIntersectingOpts{Index: "g", }).Count(), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
...

	{
		...
		suite.T().Log("About to run line #98: tbl.GetIntersecting(r.Polygon([]interface{}{0, 0}, []interface{}{1, 0}, []interface{}{1, 1}, []interface{}{0, 1}), r.GetIntersectingOpts{Index: 'g', }).Count()")

		runAndAssert(suite.Suite, expected_, tbl.GetIntersecting(r.Polygon([]interface{}{0, 0}, []interface{}{1, 0}, []interface{}{1, 1}, []interface{}{0, 1}), r.GetIntersectingOpts{Index: "g", }).Count(), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
...

	{
		...
		suite.T().Log("About to run line #102: tbl.GetIntersecting(r.Line([]interface{}{0, 0}, []interface{}{10, 10}), r.GetIntersectingOpts{Index: 'g', }).Count()")

		runAndAssert(suite.Suite, expected_, tbl.GetIntersecting(r.Line([]interface{}{0, 0}, []interface{}{10, 10}), r.GetIntersectingOpts{Index: "g", }).Count(), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
...

	{
		...
		suite.T().Log("About to run line #106: tbl.GetIntersecting(r.Point(0, 0), r.GetIntersectingOpts{Index: 'g', }).TypeOf()")

		runAndAssert(suite.Suite, expected_, tbl.GetIntersecting(r.Point(0, 0), r.GetIntersectingOpts{Index: "g", }).TypeOf(), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
...

	{
		...
		suite.T().Log("About to run line #110: tbl.GetIntersecting(r.Point(0, 0), r.GetIntersectingOpts{Index: 'g', }).Filter(true).TypeOf()")

		runAndAssert(suite.Suite, expected_, tbl.GetIntersecting(r.Point(0, 0), r.GetIntersectingOpts{Index: "g", }).Filter(true).TypeOf(), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
...

	{
		...
		suite.T().Log("About to run line #114: tbl.GetIntersecting(r.Point(0, 0), r.GetIntersectingOpts{Index: 'g', }).Map(r.Row).TypeOf()")

		runAndAssert(suite.Suite, expected_, tbl.GetIntersecting(r.Point(0, 0), r.GetIntersectingOpts{Index: "g", }).Map(r.Row).TypeOf(), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
...

	{
		...
		suite.T().Log("About to run line #119: tbl.GetIntersecting(r.Point(0, 0), r.GetIntersectingOpts{Index: 'm', }).Count()")

		runAndAssert(suite.Suite, expected_, tbl.GetIntersecting(r.Point(0, 0), r.GetIntersectingOpts{Index: "m", }).Count(), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
...

	{
		...
		suite.T().Log("About to run line #123: tbl.GetIntersecting(r.Point(1, 0), r.GetIntersectingOpts{Index: 'm', }).Count()")

		runAndAssert(suite.Suite, expected_, tbl.GetIntersecting(r.Point(1, 0), r.GetIntersectingOpts{Index: "m", }).Count(), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
...

	{
		...
		suite.T().Log("About to run line #127: tbl.GetIntersecting(r.Point(2, 0), r.GetIntersectingOpts{Index: 'm', }).Count()")

		runAndAssert(suite.Suite, expected_, tbl.GetIntersecting(r.Point(2, 0), r.GetIntersectingOpts{Index: "m", }).Count(), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
...

	{
		...
		suite.T().Log("About to run line #131: tbl.GetIntersecting(r.Point(3, 0), r.GetIntersectingOpts{Index: 'm', }).Count()")

		runAndAssert(suite.Suite, expected_, tbl.GetIntersecting(r.Point(3, 0), r.GetIntersectingOpts{Index: "m", }).Count(), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
...

	{
		...
		suite.T().Log("About to run line #136: tbl.GetIntersecting(r.Polygon([]interface{}{0, 0}, []interface{}{0, 1}, []interface{}{1, 1}, []interface{}{1, 0}), r.GetIntersectingOpts{Index: 'm', }).Count()")

		runAndAssert(suite.Suite, expected_, tbl.GetIntersecting(r.Polygon([]interface{}{0, 0}, []interface{}{0, 1}, []interface{}{1, 1}, []interface{}{1, 0}), r.GetIntersectingOpts{Index: "m", }).Count(), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
...

	{
		...
		suite.T().Log("About to run line #142: tbl.GetNearest(r.Point(0, 0), r.GetNearestOpts{Index: 'other', })")

		runAndAssert(suite.Suite, expected_, tbl.GetNearest(r.Point(0, 0), r.GetNearestOpts{Index: "other", }), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
...

	{
		...
		suite.T().Log("About to run line #146: tbl.GetNearest(r.Point(0, 0), r.GetNearestOpts{Index: 'missing', })")

		runAndAssert(suite.Suite, expected_, tbl.GetNearest(r.Point(0, 0), r.GetNearestOpts{Index: "missing", }), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
...

	{
		...
		suite.T().Log("About to run line #170: tbl.GetNearest(r.Point(0, 0), r.GetNearestOpts{Index: 'id', }).Count()")

		runAndAssert(suite.Suite, expected_, tbl.GetNearest(r.Point(0, 0), r.GetNearestOpts{Index: "id", }).Count(), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
...

	{
		...
		suite.T().Log("About to run line #175: tbl.GetNearest(r.Point(0, 0), r.GetNearestOpts{Index: 'g', }).Pluck('dist', map[interface{}]interface{}{'doc': 'id', })")

		runAndAssert(suite.Suite, expected_, tbl.GetNearest(r.Point(0, 0), r.GetNearestOpts{Index: "g", }).Pluck("dist", map[interface{}]interface{}{"doc": "id", }), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
...

	{
		...
		suite.T().Log("About to run line #179: tbl.GetNearest(r.Point(-1e-06, 1), r.GetNearestOpts{Index: 'g', }).Pluck('dist', map[interface{}]interface{}{'doc': 'id', })")

		runAndAssert(suite.Suite, expected_, tbl.GetNearest(r.Point(-1e-06, 1), r.GetNearestOpts{Index: "g", }).Pluck("dist", map[interface{}]interface{}{"doc": "id", }), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
...

	{
		...
		suite.T().Log("About to run line #183: tbl.GetNearest(r.Point(0, 0), r.GetNearestOpts{Index: 'g', MaxDist: 1565110, }).Pluck('dist', map[interface{}]interface{}{'doc': 'id', })")

		runAndAssert(suite.Suite, expected_, tbl.GetNearest(r.Point(0, 0), r.GetNearestOpts{Index: "g", MaxDist: 1565110, }).Pluck("dist", map[interface{}]interface{}{"doc": "id", }), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
...

	{
		...
		suite.T().Log("About to run line #187: tbl.GetNearest(r.Point(0, 0), r.GetNearestOpts{Index: 'g', MaxDist: 1565110, MaxResults: 2, }).Pluck('dist', map[interface{}]interface{}{'doc': 'id', })")

		runAndAssert(suite.Suite, expected_, tbl.GetNearest(r.Point(0, 0), r.GetNearestOpts{Index: "g", MaxDist: 1565110, MaxResults: 2, }).Pluck("dist", map[interface{}]interface{}{"doc": "id", }), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
...

	{
		...
		suite.T().Log("About to run line #191: tbl.GetNearest(r.Point(0, 0), r.GetNearestOpts{Index: 'g', MaxDist: 10000000, }).Pluck('dist', map[interface{}]interface{}{'doc': 'id', })")

		runAndAssert(suite.Suite, expected_, tbl.GetNearest(r.Point(0, 0), r.GetNearestOpts{Index: "g", MaxDist: 10000000, }).Pluck("dist", map[interface{}]interface{}{"doc": "id", }), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
...

	{
		...
		suite.T().Log("About to run line #195: tbl.GetNearest(r.Point(0, 0), r.GetNearestOpts{Index: 'g', MaxDist: 1566, Unit: 'km', }).Pluck('dist', map[interface{}]interface{}{'doc': 'id', })")

		runAndAssert(suite.Suite, expected_, tbl.GetNearest(r.Point(0, 0), r.GetNearestOpts{Index: "g", MaxDist: 1566, Unit: "km", }).Pluck("dist", map[interface{}]interface{}{"doc": "id", }), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
...

	{
		...
		suite.T().Log("About to run line #198: tbl.GetNearest(r.Point(0, 0), r.GetNearestOpts{Index: 'g', MaxDist: 1, GeoSystem: 'unit_sphere', }).Pluck('dist', map[interface{}]interface{}{'doc': 'id', })")

		runAndAssert(suite.Suite, expected_, tbl.GetNearest(r.Point(0, 0), r.GetNearestOpts{Index: "g", MaxDist: 1, GeoSystem: "unit_sphere", }).Pluck("dist", map[interface{}]interface{}{"doc": "id", }), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
...

	{
		...
		suite.T().Log("About to run line #202: tbl.GetNearest(r.Point(0, 0), r.GetNearestOpts{Index: 'g', }).TypeOf()")

		runAndAssert(suite.Suite, expected_, tbl.GetNearest(r.Point(0, 0), r.GetNearestOpts{Index: "g", }).TypeOf(), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
...

	{
		...
		suite.T().Log("About to run line #206: tbl.GetNearest(r.Point(0, 0), r.GetNearestOpts{Index: 'g', }).Map(r.Row).TypeOf()")

		runAndAssert(suite.Suite, expected_, tbl.GetNearest(r.Point(0, 0), r.GetNearestOpts{Index: "g", }).Map(r.Row).TypeOf(), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
