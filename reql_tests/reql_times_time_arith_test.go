...
[false, false, false, false]]]) */
		...
		runAndAssert(suite.Suite, expected_, ts.Map(func(a r.Term) interface{} { return ts.Map(func(b r.Term) interface{} { return ts.Map(func(c r.Term) interface{} { return b.During(a, c, r.DuringOpts{LeftBound: "open", })})})}), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
...
[false, false, false, true]]]) */
		...
		runAndAssert(suite.Suite, expected_, ts.Map(func(a r.Term) interface{} { return ts.Map(func(b r.Term) interface{} { return ts.Map(func(c r.Term) interface{} { return b.During(a, c, r.DuringOpts{RightBound: "closed", })})})}), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
...
[false, false, false, false]]]) */
		...
		runAndAssert(suite.Suite, expected_, ts.Map(func(a r.Term) interface{} { return ts.Map(func(b r.Term) interface{} { return ts.Map(func(c r.Term) interface{} { return b.During(a, c, r.DuringOpts{LeftBound: "open", RightBound: "closed", })})})}), suite.session, r.RunOpts{
			GeometryFormat: "raw",
			GroupFormat: "map",
		})
